...
mRemote.transact(Stub.TRANSACTION_getSignedData, _data, _reply, 0);
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(alias);
mRemote.transact(Stub.TRANSACTION_getCertificateChain, _data, _reply, 0);
_reply.readException();
_result = _reply.createByteArray();
}
finally {
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(alias);
mRemote.transact(Stub.TRANSACTION_getCertificateMetaData, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
