...
mRemote.transact(Stub.TRANSACTION_userPause, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_addAllowedExternalApp, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(packagename);
mRemote.transact(Stub.TRANSACTION_isAllowedExternalApp, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
mRemote.transact(Stub.TRANSACTION_challengeResponse, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
